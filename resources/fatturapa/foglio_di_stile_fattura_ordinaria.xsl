...
<xsl:when test="$TD='TD20'"> (autofattura per regolarizzazione e integrazione delle fatture - ex art.6 c.8 e 9-bis d.lgs. 471/97 o art.46 c.5 D.L. 331/93) </xsl:when>
...
<xsl:when test="$TD='TD28'"> (acquisti da San Marino con IVA - Fattura Cartacea) </xsl:when>
...
<xsl:when test="$NT='N7'"> (IVA assolta in altro stato UE - prestazione di servizi di telecomunicazioni, tele-radiodiffusione ed elettronici ex art. 7-octies, comma 1 lett. a, b, art. 74-sexies DPR 633/72) </xsl:when>
...
<xsl:when test="$NAT='N7'"> (IVA assolta in altro stato UE - prestazione di servizi di telecomunicazioni, tele-radiodiffusione ed elettronici ex art. 7-octies, comma 1 lett. a, b, art. 74-sexies DPR 633/72) </xsl:when>
<xsl:otherwise>
<span>(!!! codice non previsto !!!)</span>
</xsl:otherwise>
</xsl:choose>
...
<xsl:when test="$NAT1='N7'"> (IVA assolta in altro stato UE - prestazione di servizi di telecomunicazioni, tele-radiodiffusione ed elettronici ex art. 7-octies, comma 1 lett. a, b, art. 74-sexies DPR 633/72) </xsl:when>
<xsl:otherwise>
<span>(!!! codice non previsto !!!)</span>
</xsl:otherwise>
</xsl:choose>
